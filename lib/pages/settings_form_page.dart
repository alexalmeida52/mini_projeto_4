...
class SettingsFormPage extends StatefulWidget {
  ...
  SettingsFormPage(this.product, this.index);
...
class _SettingsFormPageState extends State<SettingsFormPage> {
  ...
  void initState() {
    ...
    _formData['name'] = widget.product.title;
            ...
            children: [
              ...
              ElevatedButton(
                  onPressed: _submitForm,
                    ...
                    // final productListProvider = context.read<ProductList>();
                    ...
                    // productListProvider.updateProduct(productTemp);
